...
|Office 365 多重身份验证 (MFA)  <br/> |可访问  <br/> |可访问  <br/> |可访问  <br/> |
...
|移动设备管理 (MDM)<sup>15</sup> <br/> |可访问  <br/> |可访问  <br/> |可访问  <br/> |
|移动设备管理 (MDM) 自动注册  <br/> |否  <br/> |可访问  <br/> |可访问  <br/> |
|适用于 Office 应用和 LOB 应用程序的移动应用管理 (MAM)<sup>17</sup> <br/> |否  <br/> |可访问  <br/> |可访问  <br/> |
