...
|从 Office 365 或使用 Windows PowerShell<sup>8</sup>中删除帐户并重置密码 <br/> |是  <br/> |是  <br/> |
...
|使用本地 AD 写回的自助服务密码重置  <br/> |否  <br/> |是  <br/> |是  <br/> |
...
|使用 Azure AD 加入的 Windows 10 企业版状态漫游  <br/> |否  <br/> |是  <br/> |是  <br/> |
