...
| 来宾访问 | Microsoft 365完整来宾Yammer需要本机模式。 <br/>旧版网络级别的来宾可能会遇到文件访问问题。 |
...
| 来宾访问 | 规范网络的成员可以在会议现场创建或参加Yammer。 |
...
| 功能 | 详细信息 |
|---------|---------|
| 社区中的成员数 | 根据社区是否连接到一个[Microsoft 365组、](/yammer/manage-yammer-groups/yammer-and-office-365-groups)动态社区还是所有[公司](/yammer/manage-yammer-groups/yammer-all-company-yammer-community)社区而异。 [](/yammer/manage-yammer-groups/create-a-dynamic-group) <br/>动态社区成员身份限制：500，000 |
| 可成为成员的社区数 | 7,000 |
...
| 对私有社区待定成员的限制 | 无限制。 |
| 本机模式下社区管理的限制 | 应该使用旨在更新组Microsoft 365管理已连接的组，包括 Microsoft 365 管理门户、Azure AD 门户和 Azure AD PowerShell 模块。 |
| 通过电子邮件发布 | 无限制 |
...
| 链接预览 (开放Graph元数据)  |<ul><li>链接内容的预览只能针对公共内容和一些受支持的资源Microsoft 365预览。</li><li>预览生成取决于发布时是否成功提取元数据，根据要链接到的网站的可用性，元数据提取可能会有所不同。</li><li>不支持指向组织防火墙内部系统的链接或需要身份验证的链接。 </li><li>首次使用网络内的链接后，可能不会更新链接预览元数据。</li></ul> |
...
| 功能 | 详细信息 |
|---------|---------|
| 外部网络 | 如果这 5 个外部网络通常只有一个成员 (，则管理员可创建的 5 个外部网络的限制，该成员是网络创建者) 。 <br/> 如果外部网络中至少有一个其他用户，则不计入该限制。 |
