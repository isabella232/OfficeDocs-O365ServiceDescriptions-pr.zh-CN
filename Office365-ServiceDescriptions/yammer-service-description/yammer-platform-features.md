...
将 Yammer 选项卡添加到浏览器菜单中，并允许您快速共享正在查看的任何网页，方法为选择 Yammer 图标、选择要将邮件张贴到哪个组，以及使用指向页面的链接共享您自己的评论。 如果存在有关页面的现有的 Yammer 对话，则扩展会通知你。 

## <a name="embeddable-feeds"></a>可嵌入源

简单的代码段可使您将任何 Yammer 新闻复制嵌入到您的业务应用程序中。
  
## <a name="like-and-follow-buttons"></a>"喜欢"和"关注"按钮

将"赞"和"关注"按钮添加到您的业务应用程序，以便员工可以在 Yammer 之外处理对象。
  
## <a name="yammer-connect-login"></a>Yammer连接登录

将"登录"按钮添加到业务应用程序，以便用户可以轻松地注册和登录其Yammer帐户。
