...
> [!NOTE]
> EOP 更换了适用于 Exchange (FOPE) 的 Forefront Online Protection。 所有 FOPE 客户都已转换到 EOP。
...
| 套餐 | 说明 |
|:-----|:-----|
|[独立 EOP](https://products.office.com/exchange/exchange-email-security-spam-protection)|一种单独的基于云的服务，可保护您的内部部署电子邮件组织。|
...
|[Exchange 企业版 CAL 带服务](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business)|为内部部署 Exchange 组织购买的加载项许可证包括 EOP 和其他基于云的功能 (请参阅下一节，了解详细信息) 。|
