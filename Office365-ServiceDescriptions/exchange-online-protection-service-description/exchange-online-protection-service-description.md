...
若要了解 EOP 新增功能，请参阅 [What's New in Exchange Online Protection](https://docs.microsoft.com/office365/SecurityCompliance/eop/exchange-online-protection-overview)（Exchange Online Protection 中的新增功能）。有关 FOPE 与 EOP 功能比较，请参阅 [FOPE vs. EOP Feature Comparison](https://go.microsoft.com/fwlink/p/?LinkId=320391)（FOPE 与 EOP 功能比较）。
...
|**计划**|**说明**|
|:-----|:-----|
|[EOP standalone](https://docs.microsoft.com/office365/securitycompliance/eop/exchange-online-protection-overview)（EOP 独立） <br/> |其中 EOP 保护本地邮箱。  <br/> |
|[EOP features in Exchange Online](https://products.office.com/exchange/compare-microsoft-exchange-online-plans)（Exchange Online 中的 EOP 功能） <br/> |其中 EOP 保护 Exchange Online 云托管的邮箱。  <br/> |
|[Exchange Enterprise CAL with Services](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business) <br/> |其中 EOP 保护您的本地邮箱（如同独立 EOP 一样），并包含数据丢失防护 (DLP) 和使用 Web 服务的报告。  <br/> |
...
有关 Exchange Enterprise CAL with Services 许可的详细信息，请参阅 [Exchange Server 2013 licensing](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business)（Exchange Server 2013 许可）。
  
如果你拥有 Exchange Enterprise CAL with Services 许可证，并且想要预配服务，请按[设置 EOP 服务](https://docs.microsoft.com/office365/SecurityCompliance/eop/set-up-your-eop-service)中的说明操作。设置步骤与设置 EOP 独立的步骤相同。
...
EOP 可与任意 SMTP 邮件传输代理（如 Microsoft Exchange Server 2013）结合使用。若要了解 EOP 支持的操作系统、Web 浏览器和语言，请参阅 [Exchange Online Protection [EOP] 中的 Exchange 管理中心](https://docs.microsoft.com/office365/securitycompliance/exchange-admin-center-in-exchange-online-protection-eop)中的"支持的浏览器"和"支持的语言"部分。
