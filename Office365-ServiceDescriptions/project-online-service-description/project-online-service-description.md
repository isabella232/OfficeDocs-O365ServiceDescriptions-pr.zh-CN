...
description: Project Online是一种灵活的在线解决方案，用于项目组合管理和 (PPM) 日常工作。 通过 Office 365，Project Online几乎从任何位置在任何设备上提供强大的项目管理功能，用于规划、确定项目和项目组合投资优先级和管理。 Project Online 适用于管理员、项目组合经理、项目组合查看者、项目经理、资源经理、工作组领导和成员。
ms.openlocfilehash: df6f4ffc3d8c95ab3b4882a7d337e7f880f3b368
ms.sourcegitcommit: c117bb958f5b94682fd384b4770a920c6114559b
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/24/2021
ms.locfileid: "59672555"
---
...
本文将帮助你了解每个订阅中Project应用程序以及每个应用程序提供的功能。

### <a name="project-for-the-web"></a>Project 网页版

Project是 Microsoft 最新的基于云的工作和项目管理产品/服务。 Project Web 服务提供了简单、强大的工作管理功能，以满足大多数需求和角色。 Project管理员和团队成员可以使用 Project Web 功能来规划和管理任何规模的工作。
...
Project订阅提供适用于 Web 的订阅：Project 计划 1、Project 计划 3 和 Project 计划 5。 Web 功能[Project中列出的功能](#project-for-the-web-features)仅与 Web 数据存储区Project数据进行交互。

### <a name="project-online"></a>Project Online
 
Project Online是一种灵活的联机解决方案，Project项目组合 (PPM) 和日常工作。 Project Online几乎任何设备上提供强大的项目管理功能，用于从几乎任何位置规划、确定项目和项目组合投资 &mdash; 优先级以及管理项目组合投资。 Project Online 适用于管理员、项目组合经理、项目组合查看者、项目经理、资源经理、工作组领导和成员。
...
团队的成员功能Project Online订阅或Project Online 协作版Project 计划 1功能。 Project Online 协作版订阅是具有订阅或 *已订阅的* 客户的Project 计划 3加载项Project 计划 5订阅。 Project Online 协作版和Project 计划 1订阅为工作组成员提供了一个 Web 界面，用于对在 Project Online 中管理的项目执行任务和Project Online。
...
Project Online 协作版不包括Project网站的网站。 Project 计划 1 Web Project和 web Project Online 协作版。
...
尽管Project Web 和 Project Online是单独的应用程序，但可以并排使用它们。 You can see all your projects from both applications in Project Home. 可以使用 Project 路线图功能来构建包含这两个应用程序中的项目的路线图。 此外，您还可以使用 Power BI 和 Project 网页Power BI内容包，深入了解这两个应用程序中的项目和资源。<sup>3</sup>

此图显示了应用程序如何并行协作。

![显示 Web Project网站和网站Project Online图。](../media/project-online-applications.png)
...
|路线图 | 构建跨项目的可视化交互式Microsoft Project Online、Microsoft Project Web 和 Azure Boards 项目。<sup>2 Project 计划 1</sup>可获取对路线图的只读访问权限。 通过Project 计划 3或Project 计划 5，您还可以创建路线图。 | 仅查看 | 仅查看 | 是 | 是 |
|**报告**<sup>3</sup> ||||||
...
|**第三方应用**||||||
|*连接Project第三方* 应用访问 Web <sup>4</sup> | 使用自定义或第三方应用程序查看、创建、更新或删除Project本机数据表中的Project数据。 | 仅查看<sup>11</sup> | 是 | 是 | 是 |

### <a name="project-online-features"></a>Project Online 功能

本节中列出的功能仅与数据存储区Project Online SharePoint交互。 订阅或Project Online 协作版Project 计划 1团队成员可以执行一些Project Online功能。 有关详细信息，请参阅服务[Microsoft Project - 服务说明|Microsoft Docs](/office365/servicedescriptions/project-online-service-description/project-online-service-description#project-online)。<br><br>

|功能 | 说明 | Project 计划 3 | Project 计划 5 |
|--------|-------------|-----------------------------|------------------------|
|**Project、任务和时间管理**||||
|警报和提醒 | 定期安排重要的即将开始的任务和项目事件，并定期Outlook Microsoft Teams。<sup>1</sup>| 是 | 是 |
...
|任务计划 | 使用任务开始日期和结束日期、工作量、工作、前导和延隔时间以及依赖关系，使用任务开始日期和结束日期，获取项目日期的准确Project Web App。 | 是 | 是 |
...
|**需求管理** ||||
|Project审批工作流设置 | 构建评估、确定传入需求优先级和批准传入需求所需的工作流。 | 否 | 是 |
|Project请求表单创建 | 捕获有关传入需求的重要数据，以帮助你评估和确定新工作的优先级。 | 否 | 是 |
|Project请求 | 跟踪、管理、评估和确定来自组织内部以及外部客户和合作伙伴的传入需求的优先级。 | 是 | 是 |
|**资源、计划以及项目组合管理** ||||
|Project成本和预算 | 使用计划进度和预算与实际时间和成本Project Web App。 | 是 | 是 |
|Project团队设置 | 通过添加和删除成员、设置分配级别和添加外部成员来管理项目工作组。 | 是 | 是 |
...
|路线图 | 构建跨项目的可视化交互式Microsoft Project Online、Microsoft Project Web 和 Azure Boards 项目。<sup>2</sup> | 是 | 是 |
...
|自定义报表 | 通过基于开箱即用报表或从头开始生成自定义报告，了解对组织非常重要的数据。 | 是 | 是 |
...
|PowerApps | 通过 PowerApps 的 OData (生成和使用 web 和) 解决方案。<sup>4</sup> | 是 | 是 |
...
<sup>3</sup>使用 Project web 和 Project Online 报告Power BI需要Power BI许可证。<br/>
...
<sup>6 Project Online</sup>用户的许可遵循与内部用户相同的策略。 网站的任何交互Project Online需要Project 计划 3或Project 计划 5订阅。<br/>
...
<sup>8</sup>拥有 Project 计划 3 或 Project 计划 5 订阅的用户可以提交资源预订请求。 他们无法审阅、履行或批准资源参与请求。<br/>
<sup>9</sup>拥有资源预订Project 计划 5可以审阅、履行和批准资源预订请求。<br/>
<sup>10</sup> Active Directory 需要单独的订阅。 <br/>
<sup>11</sup> 仅从 Power App 内授予仅查看权利。 <br/>
<sup>12</sup>具有 Microsoft Project 计划 3/5 许可证 () 仅允许使用通用资源计划在项目上下文中安排 Project 表和任务表。 <br/>
...
|Project成本和预算 | 将计划进度和预算与实际时间和成本进行比较。 |
|资源成本计算 | 跟踪和管理项目的资源成本。|
|**报告** ||
|自定义报表 | 生成项目、计划、项目组合和资源自定义报告。 |
...
|Excel导入/导出 | 从现有Excel新建项目，或Excel现有项目的新建项目文件。 |

## <a name="service-considerations"></a>服务注意事项

> [!NOTE]
> Project当前无法用于 GCC、GCC High 和 DoD。 我们正在致力于为您提供Project Web 服务，但此时无法共享一个稳固的时间范围。
...
- 当最后一Project 计划 3订阅Project 计划 5订阅过期时，Project Online实例将在 120 天后删除。
...
Project Online要求使用 SharePoint Online，它作为 Project Online 的一Project Online。 对 SharePoint 订阅或 Project 计划 3 Project 计划 5 Online 功能的访问权限仅限于存储和访问数据以支持Project Online。

### <a name="project-roadmap-and-power-automate"></a>Project路线图和Power Automate

Project路线图要求使用 Power Automate，它作为你的订阅的一Project进行预配。 对Power Automate权限仅限于 Power Automate 路线图所需的Project功能。 Power Automate路线图所需的Project在 Microsoft 365 管理中心 的应用部分中显示为 Project Flow **服务计划** 的数据集成。 

### <a name="project-for-the-web-and-microsoft-dataverse"></a>Project和 Microsoft Dataverse 的搜索

Project需要使用 Microsoft Dataverse 来存储其数据。 Microsoft Dataverse 数据库作为你的订阅的一Project设置。 对 Microsoft Dataverse 功能的访问权限仅限于存储和访问数据，以支持Project Web 应用。 Project的"应用程序"部分Project Common Data Service **for Microsoft 365 管理中心。** 
...
| 包含/累算的容量                                      | ProjectP1 | ProjectP3 | ProjectP5 |
|--------------------------------------------------------------------|------------|------------|------------|
| Dataverse (Common Data Service) 数据库：包含/租户 | 3 GB        | 5 GB        | 5 GB        |
| Dataverse 数据库：USL 数据库的累计/用户 (许可证)         | 50 MB       | 250 MB      | 250 MB      |
...
Project Web 和 Project Online 都具有相同的数据备份和保留策略，Office 365。 有关详细信息，请参阅数据保留[、删除和销毁Office 365。](/office365/Enterprise/office-365-data-retention-deletion-and-destruction-overview)
...
### <a name="project-for-the-web-boundaries-and-limitations"></a>Project边界和限制
