...
- 整个解码文件路径（包括文件名）不能包含 OneDrive、OneDrive 或学校以及 Microsoft 365 中SharePoint 400 个字符。 该限制适用于解码后的文件夹路径和文件名的组合。 有关详细信息，请转到文件名  [和路径长度](https://support.microsoft.com/office/restrictions-and-limitations-in-onedrive-and-sharepoint-64883a5d-228e-48f5-b3d2-eb39e07630fa#filenamepathlengths)。
...
每个网站集网站组合 2，000 个列表和 (包括主网站和任何子网站) 。 我们建议将列表和库组织到网站集中，而不是在同一 Web 下创建过多列表或库。
