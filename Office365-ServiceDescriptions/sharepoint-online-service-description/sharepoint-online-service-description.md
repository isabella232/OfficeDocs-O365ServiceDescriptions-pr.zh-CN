...
- [适用于经典网站) 的 SharePoint Designer 2013 (](https://support.office.com/article/66bf58fe-daeb-4fa6-ae84-fd600e0005c1)。 不适用于 firstline 工作人员。
...
- [迁移： Mover.io](https://mover.io/)。 现在在全球范围内可用。
- [多地理位置 (数据驻留) ](/office365/enterprise/multi-geo-capabilities-in-onedrive-and-sharepoint-online-in-office-365)。 使用至少需要500个 Microsoft 许可证的加载项。 有关详细信息，请联系你的 Microsoft 代表。
...
- [ (IRM) 的信息权限管理 ](/office365/securitycompliance/set-up-irm-in-sp-admin-center)。 需要独立或作为套件的一部分的 Azure 信息保护。 某些 Azure 信息保护功能需要订阅适用于企业的 Microsoft 365 应用程序。
...
- [创建计划 (Planner integration) ](https://support.office.com/article/73040e0a-560e-41a0-b520-47c1a3bab3cb)。 需要包含 Office 365 的订阅，并且要求用户为计划程序授予许可证。
...
- [管理 (经典和新式搜索的结果源) ](/sharepoint/manage-result-sources)
- [Microsoft 搜索集成](/microsoftsearch/overview-microsoft-search)
- [ (经典搜索) 的已升级结果 ](/sharepoint/manage-query-rules)
- [ (经典和新式搜索) 删除搜索结果 ](/sharepoint/remove-search-results)
- [搜索中心 (经典搜索) ](/sharepoint/manage-search-center)
- [ (经典和新式搜索) 的搜索架构 ](/sharepoint/manage-search-schema)
