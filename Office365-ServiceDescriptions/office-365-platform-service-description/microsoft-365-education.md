...
每个 Microsoft 365 教育版计划都包含许多单独的服务，例如 Exchange Online 和 SharePoint Online。 下表显示了每个 Office 365 和 Microsoft 365 计划中提供的服务，以便您可以选择最能满足您的需求的解决方案。 若要更详细地查看服务和功能，请参阅 [Office 365 教育](office-365-education.md) 版服务说明。<br></br>
...
|**Azure Active Directory**|**Office 365 教育版 A1**|**Office 365 教育版 A3**|**Office 365 教育版 A5**|**Microsoft 365 教育版 A3**|**Microsoft 365 教育版 A5**|**Office 365 A3 学生使用权益**|**Office 365 A5 学生使用权益**|**Microsoft 365 教育版学生使用权益**|**Microsoft 365 教育版学生使用权益**|
...
|Azure 信息保护计划1|否|否|否|是|否|否|否|否|否|
...
|电子邮件和文件的数据丢失防护 (DLP) |否|是|是|是|是|否|否|否|否|
|终结点 DLP|否|否|否|否|是|否|否|否|否|
|通信 DLP (团队聊天) |否|是|是|是|是|否|否|否|否|
...
|Microsoft Defender for Office 365<sup>10</sup> 计划2|否|否|否|否|是|否|是|否|是|
|学校数据同步|是|是|是|是|是|是|是|是|是|
|高级安全管理|否|是|是|是|是|否|否|否|否|
|Intune for 教育版<sup>6</sup>|否|否|否|是|是|否|否|是|是|
...
> <sup>7</sup> 为 Exchange、SharePoint 和 Skype for business 提供了7台服务器和 cal。 <br/>
> <sup>8</sup> ECAL 或 Core CAL （具体取决于所购买的 A3 版本）和 A5，包括 ECAL 权限。 <br/>
> <sup>9</sup> Microsoft 365 应用程序是应用保护并从 Outlook 桌面发送受保护的电子邮件所必需的。 <br/>
> <sup>10</sup> 以前的 Office 365 高级威胁防护。 <br/>
> <sup>11</sup> 以前的 Azure 高级威胁防护。 <br/>
> <sup>12</sup> 以前的 Microsoft Defender 高级威胁防护。 <br/>
