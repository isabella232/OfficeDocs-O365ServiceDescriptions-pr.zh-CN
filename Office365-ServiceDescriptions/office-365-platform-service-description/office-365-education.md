...
本文列出了适用于教育Office 365计划 (A1、A3 和 A5) 。 若要跨业务和企业计划比较功能，请参阅[比较 Office 365 for Business](https://www.microsoft.com/microsoft-365/business/compare-more-office-365-for-business-plans)计划，或者有关功能的详细列表，请参阅 Microsoft 365 和 Office 365 服务说明下的相关[服务说明](../office-365-service-descriptions-technet-library.md)。
...
|:-----|:-----|:-----|:-----|
|Office 365平台  <br/> |是  <br/> |是  <br/> |是  <br/> |
...
|YammerAcademic  <br/> |是  <br/> |是  <br/> |是  <br/> |
|Azure 信息保护<sup>2</sup> <br/> |是  <br/> |是  <br/> |是  <br/> |
   
> [!NOTE]
> <sup>1 Microsoft Project</sup>不包含在Office 365但可以单独获取。 Project Online 协作版免费。 如果你是学生或教育机构，你可能有资格以教育价格Project计划 3 和计划 5。   <br/> 
<sup>2</sup>若要了解有关哪些 Azure 信息保护功能包含在 Office 365计划中，请参阅[Azure 信息保护](https://azure.microsoft.com/services/information-protection/)。<br/> 
...
下表列出了所有可用于教育计划Office 365功能。 有关计划中定价和功能的特定信息，请参阅Office 365 教育版[计划。](https://products.office.com/en/academic/compare-office-365-education-plans)<br><br>
...
|删除帐户并重置用户密码，Office 365<sup>2 Windows PowerShell重置用户密码</sup> <br/> |是  <br/> |是  <br/> |是  <br/> |
...
|Advanced eDiscovery<sup>7</sup> <br/> |否  <br/> |否  <br/> |是  <br/> |
...
<sup>7</sup> Advanced eDiscovery美国和西欧地区（荷兰 (地区) 支持。  (加拿大和亚太地区的客户数据将导出到美国。 来自欧洲、中东和非洲的客户数据将导出到西欧 [荷兰])  <br>
...
<sup>10</sup>系统会自动将"简介"电子邮件提供给 Exchange Online。 有关详细信息，请参阅 [配置简介电子邮件](/Briefing/be-admin)。<br>

## <a name="security-amp-compliance-center-features"></a>安全 &amp; 与合规中心功能

安全[ &amp; 与合规](/microsoft-365/compliance/go-to-the-securitycompliance-center)中心旨在帮助你管理组织中跨Office 365合规性功能。 Links to existing SharePoint and Exchange compliance features bring together compliance capabilities across Office 365. 
...
|[Advanced eDiscovery](/office365/securitycompliance/compliance20/overview-ediscovery-20)<sup>4</sup> <br/> |否  <br/> |否  <br/> |是  <br/> |
...
<sup>3</sup> 无限制。 <br/> 
<sup>4</sup> Advanced eDiscovery美国和西欧地区（荷兰 (地区) 支持。  (加拿大和亚太地区的客户数据将导出到美国。 来自欧洲、中东和非洲的客户数据将导出到西欧 [荷兰])  <br/> 
...
使用下表比较跨教育计划Office 365可用性。<br><br>
...
<sup>4</sup> Office Web 版本的版本。 有关详细信息，请参阅 Office [Web 功能](office-365-education.md#office-for-the-web-features)
  
## <a name="office-for-the-web-features"></a>Office 网页版功能

下表提供了一些链接，这些链接指向Office教育计划中提供的 Web 功能Office 365功能与功能丰富的桌面Microsoft Office功能进行比较。 使用比较可发现 Web Office中可用的功能，然后选择功能名称阅读有关该功能工作方式的简短说明。 你可能会发现，您的组织中的某些人员可能需要 Excel 桌面应用的高级图表功能，而其他人可能只需要使用 Office 网页版查看和轻松编辑 Word 文档和 PowerPoint 演示文稿。
  
> [!NOTE]
> - 仅选择了数量有限的 Office 功能来代表 Office 桌面套件的高级功能。 <br/>
> - 这些表格并未列出全部 Microsoft Office 功能。 <br/> 
> - Microsoft Microsoft 365 企业应用版 是最新桌面套件的每月订阅Office服务。 <br/>
> - Microsoft Office如果联机服务器本地客户已购买 Office 桌面套件许可证 (如 Office Professional Plus、Office Standard 或 Microsoft 365 企业应用版 许可证) ，则在线服务器本地客户会获得 Web 编辑许可证的 Office。 
...
下表列出了Exchange Online教育计划中可用的Office 365功能。<br><br>
...
|Outlook <sup>9</sup> Windows <br/> |是  <br/> |是  <br/> |是  <br/> |
|Outlook Web<sup>9</sup> <br/> |是  <br/> |是  <br/> |是  <br/> |
|Outlook for Mac<sup>9</sup> <br/> |是  <br/> |是  <br/> |是  <br/> |
|Outlook iOS 和 Android<sup>9</sup> <br/> |是  <br/> |是  <br/> |是  <br/> |
...
> [!NOTE]
> <sup>1</sup> Windows服务器 AD RMS 是一款本地服务器，必须单独购买和管理，才能启用支持的 IRM 功能。 <br/>
<sup>2</sup> 传输规则由灵活条件（允许您定义条件和例外）以及基于条件采取的操作（这些条件）所决定。 2013 年 Exchange Online 和 Microsoft Exchange Server 条件及操作不同。 有关可用条件和操作的列表，请参阅每款产品的相应条件和操作主题。 <br/> 
...
<sup>5</sup>已连接帐户受 POP 和 IMAP 帐户支持，但已禁用 Outlook.com (Hotmail) 。 <br/> <sup>6</sup> 不支持使用 cmdlet 处理地址列表和全局地址列表。 <br/> 
...
- **地址列表** 限制 - 在 2013 年 10 月或 2013 Exchange Online中创建Exchange Server列表的最大数量。 此数目包括 Exchange Online 中的默认地址列表，如"所有联系人"和"所有组"。 
    
- **脱机通讯簿限制**- 在 (或) 2013 组织中Exchange Online或Exchange Server OAB 通讯簿的最大数量。 
    
- **通讯簿策略限制**- 在 (2013) 中创建的通讯簿策略Exchange Online Exchange Server数量。 
    
- **全局地址列表**- 在 (2013) 中创建的全局地址列表Exchange Online EXCHANGE SERVER数。 
...
- 禁止 **发送/** 接收 - Exchange Online达到邮箱大小限制时拒绝任何传入邮件，并将未送达报告 (NDR) 发件人。 发件人可选择稍后尝试重新发送该邮件。 若要再次接收邮件，用户必须删除邮件，直到邮箱的使用容量低于大小限制为止。 
...
- **每个邮箱文件夹** 的邮件数量的警告 - 指定邮箱文件夹在向邮箱所有者发送Exchange Online之前可以保留的邮件数。 达到此配额时，将每天发送一次警告消息。 
...
- **"** 可恢复邮件"文件夹中每个文件夹的邮件数量的警告 - 指定"可恢复的项目"文件夹中每个文件夹在将事件记录到应用程序事件日志Exchange Online可以保留的邮件数。 
...
- **每个公用** 文件夹的子文件夹数量的警告 - 指定在 Exchange Online 向文件夹所有者发送警告消息之前可在公用文件夹中创建的子文件夹的数量。 如果不存在所有者，则警告消息会发送到具有所有者权限的用户。 达到此配额时，将每天发送一次警告消息。 
...
<sup>4</sup>要移动到邮件中Exchange Online的大小由Exchange Online。 Exchange Server 2013 之前的 Exchange 版本可能会报告较小的邮件大小。 此限制适用于使用任何受支持 Exchange 邮箱复制服务的基于移动的迁移。 其他迁移方法（直接转换、暂存、IMAP、PST）和其他第三方工具具有常规邮件大小限制。 <br/> 
...
- **Exchange ActiveSync删除限制**- Exchange ActiveSync管理员可以在一个月内Exchange删除的最大设备数。 
...
OneDrive for Business (SkyDrive Pro) 云中的个人联机存储空间。 使用它，可以轻松、安全地跨多个设备存储工作文件。 根据需要与同事共享文件，并实时Office Web Office编辑文档。 使用"同步"应用将文件OneDrive for Business本地计算机。
  
OneDrive for Business 包含在 SharePoint Online 中，也可以作为独立的计划购买。 "OneDrive for Business独立"选项Office Web 应用。 若要了解更多信息，请参阅[什么是OneDrive for Business？。](https://support.office.com/article/187f90af-056f-47c0-9656-cc0ddca7fdc2?ocmsassetID=HA102822076)
...
以下符合条件的计划为OneDrive 5 个用户的订阅提供无限制的存储空间。 Microsoft 将为每个用户提供初始 5 TB 的存储空间。 需要额外存储OneDrive客户可以根据需要联系 Microsoft 支持部门来请求它。 用户数少于 5 的订阅每用户可获得 1 TB 的存储。
...
有关无法添加到列表的文件类型OneDrive for Business，请参阅无法添加到列表或[库的文件的类型](https://support.office.com/article/30be234d-e551-4c2a-8de8-f8546ffbf5b3)。
  
SharePoint Online 随附 OneDrive for Business。 若要了解 SharePoint Online 中的其他限制，例如网站集配额、文件上载限制和存储限制，请参阅 SharePoint Online 软件边界[和限制](../sharepoint-online-service-description/sharepoint-online-limits.md)。
  
### <a name="subscription-plans"></a>订阅计划

OneDrive for Business计划 2 适用于 Office 365 A1 A3 和 A5。 若要查看计划中可用的功能，请参阅服务OneDrive for Business[说明](../onedrive-for-business-service-description.md)。
...
下表显示了每个SharePoint教育计划Office 365限制。<br><br>
...
|存储网站集的库  <br/> |每个网站集或组<sup>4</sup>最多 25 TB <br/> |每个网站集或组<sup>4</sup>最多 25 TB <br/> |每个网站集或组<sup>4</sup>最多 25 TB <br/> |
...
> [!NOTE]
> <sup>1</sup>你可以购买无限量的额外存储空间SharePoint在线存储空间。 请参阅 [为订阅添加存储空间](https://support.office.com/article/96EA3533-DE64-4B01-839A-C560875A662C)。 <br/> <sup>2</sup> 我们建议监视回收站并定期清空回收站。 The storage space it uses is part of the organization's total file storage limit.<br/> 
<sup>3</sup>当你拥有订阅和 SharePoint Online 独立计划时，会添加存储量。<br/> 
...
> [!NOTE]
> 此表指示跨教育选项Office 365和服务可用性。 若要比较各种桌面客户端、Skype for Business客户端和移动客户端之间的单个功能，请参阅[Skype for Business Online 客户端比较](/lyncserver/lync-server-2013-desktop-client-comparison-tables)表和[移动客户端比较表](/lyncserver/lync-server-2013-mobile-client-comparison-tables)。 
...
|Skype for Business完整  <br/> |否  <br/> |是  <br/> |是  <br/> |
|Skype for Business基本  <br/> |是<sup>1</sup> <br/> |否  <br/> |否  <br/> |
...
|Skype for Business ACP 会议提供商通过经认证的音频会议提供商 (会议)   <br/> |是  <br/> |是  <br/> |是  <br/> |
...
|使用 Skype for Business计划程序安排会议  <br/> |是  <br/> |是  <br/> |是  <br/> |
...
有关在线国内和国际呼叫计划中分钟Skype for Business的信息，请参阅 Skype for Business [Online PSTN 服务使用条款](/microsoftteams/complimentary-dial-out-period#skype-for-business-pstn-services)。
