...
description: 为了最好地满足您的组织的需要，许多计划中都提供了 Microsoft Office 365。 如果你要查找教育计划Office 365差异，本文将介绍每个计划中包含的功能。 Office 365将熟悉的 Microsoft Office 桌面套件与 Microsoft 下一代通信和协作服务的基于云的版本（包括 &mdash; Microsoft Exchange Online、Microsoft Office SharePoint Online、Office 网页版和 Microsoft Skype for Business Online 帮助用户从几乎 &mdash; 任何位置通过 Internet 提高工作效率。
ms.openlocfilehash: 55e285a62f2e4a955e88a416f40c800ad1489ff7
ms.sourcegitcommit: c117bb958f5b94682fd384b4770a920c6114559b
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/24/2021
ms.locfileid: "59671405"
---
# <a name="office-365-education"></a>Office 365 教育版

为了最好地满足您的组织的需要，许多计划中都提供了 Microsoft Office 365。 如果你要查找教育计划Office 365差异，本文将介绍每个计划中包含的功能。 Office 365将熟悉的 Microsoft Office 桌面套件与 Microsoft 下一代通信和协作服务的基于云的版本（包括 &mdash; Microsoft Exchange Online、Microsoft Office SharePoint Online、Office 网页版和 Microsoft Skype for Business Online 帮助用户从几乎 &mdash; 任何位置通过 Internet 提高工作效率。
  
本文列出了适用于教育Office 365计划 (A1、A3 和 A5) 。 若要跨业务和企业计划比较功能，请参阅[比较 Office 365 for Business](https://www.microsoft.com/microsoft-365/business/compare-more-office-365-for-business-plans)计划，或者有关功能的详细列表，请参阅 Microsoft 365 下的相关服务说明Office 365[服务说明](../office-365-service-descriptions-technet-library.md)。
...
<sup>2</sup>若要详细了解哪些 Azure 信息保护功能包含在Office 365计划中，请参阅 Azure[信息保护](https://azure.microsoft.com/services/information-protection/)。<br/> 
...
<sup>7</sup> Advanced eDiscovery美国和西欧地区（荷兰 (地区) 支持。  (加拿大和亚太地区的客户数据将导出到美国。 将欧洲、中东和非洲的客户数据导出到西欧 [荷兰])  <br>
...
安全[ &amp; 与合规](/microsoft-365/compliance/go-to-the-securitycompliance-center)中心旨在帮助你管理组织中Office 365合规性功能。 Links to existing SharePoint and Exchange compliance features bring together compliance capabilities across Office 365. 
...
|[电子数据展示案例](/office365/securitycompliance/ediscovery-cases) <br/> |是  <br/> |是  <br/> |是  <br/> |
...
<sup>3</sup> 无限制。 <br/> 
<sup>4</sup> Advanced eDiscovery美国和西欧地区以及荷兰 (地区) 支持。  (加拿大和亚太地区的客户数据将导出到美国。 来自欧洲、中东和非洲的客户数据将导出到西欧 [荷兰])  <br/> 
...
使用下表比较各教育计划Office 365可用性。<br><br>
...
下表提供了一些链接，这些链接指向Office 网页版教育计划Office 365功能丰富的桌面Microsoft Office功能比较。 使用比较可发现哪些功能Office 网页版然后选择功能名称阅读有关该功能工作方式的简短说明。 您可能会发现，您的组织中的某些人员可能需要 Excel 桌面应用的高级图表功能，而其他人可能只需要使用 Office 网页版 查看和轻松编辑 Word 文档和 PowerPoint 演示文稿。
...
>- [修复Outlook Office 365 Microsoft 支持和恢复助手 for Office 365 的 支持和恢复助手 和 Office 365](https://diagnostics.office.com/)
...
- **地址列表** 限制 - 在 2013 年 10 月或 2013 年 3 月Exchange Online创建Exchange Server列表的最大数目。 此数目包括 Exchange Online 中的默认地址列表，如"所有联系人"和"所有组"。 
    
- 脱机 **通讯簿限制**- 2013 (2013) 中创建的脱机通讯簿的最大Exchange Online OAB Exchange Server数。 
    
- **通讯簿策略限制**- 在 (2013) 中创建的 ABP 策略Exchange Online Exchange Server数量。 
    
- **全局地址列表**- 在 (2013) 或 Exchange Online EXCHANGE SERVER GAL 地址列表的最大数量。 
...
- **每个邮箱文件夹** 的子文件夹数量的警告 - 指定在向邮箱所有者发送警告Exchange Online之前可以在邮箱文件夹中创建的子文件夹的数量。 达到此配额时，将每天发送一次警告消息。 
...
- **每个公用文件夹的** 子文件夹数量的警告 - 指定在向文件夹所有者发送警告消息Exchange Online可以在公用文件夹中创建的子文件夹的数量。 如果不存在所有者，则警告消息会发送到具有所有者权限的用户。 达到此配额时，将每天发送一次警告消息。 
...
<sup>4</sup>要移动到电子邮件中Exchange Online由邮件Exchange Online。 Exchange Server 2013 之前的 Exchange 版本可能会报告较小的邮件大小。 此限制适用于使用任何受支持 Exchange 邮箱复制服务的基于移动的迁移。 其他迁移方法（直接转换、暂存、IMAP、PST）和其他第三方工具具有常规邮件大小限制。 <br/> 
...
|转发邮件的收件人限制  <br/> |10 位收件人  <br/> |10 位收件人  <br/> |10 个收件人  <br/> |
...
- **仲裁邮箱** 的最大大小 - 如果仲裁邮箱超过此限制，则要求仲裁的邮件在 NDR 邮箱的未送达报告中 (发件人) 。 
...
- **Exchange ActiveSync文件附件** 限制 - 由邮件设备发送或接收的邮件文件附件Exchange ActiveSync大小。 
...
以下符合条件的计划为OneDrive 5 个用户的订阅提供无限存储空间。 Microsoft 将为每个用户提供初始 5 TB 的存储空间。 需要额外存储OneDrive客户可根据需要联系 Microsoft 支持部门来请求它。 用户数少于 5 的订阅每用户可获得 1 TB 的存储。
...
无法向特定用户分配OneDrive存储空间。 但是，您可以降低用户看到的存储量。 如果 Office 365 企业版 F3 用户需要更多存储空间，则需要升级到 Office 365 企业版 E1。
...
OneDrive for Business计划 2 适用于 Office 365 A1 A3 和 A5。 若要查看计划中可用的功能，请参阅OneDrive for Business[服务说明](../onedrive-for-business-service-description.md)。
...
> [!NOTE]
> 此表指示跨教育选项Office 365和服务可用性。 如果要比较各种桌面客户端、Web 客户端和移动客户端Skype for Business功能，请参阅[Skype for Business Online](/lyncserver/lync-server-2013-desktop-client-comparison-tables)客户端比较表和移动客户端[比较表](/lyncserver/lync-server-2013-mobile-client-comparison-tables)。 
...
- **会议参与者Skype for Business** - 会议的最大参与者 (包括演示者) 可加入单个会议Skype for Business会议。 
