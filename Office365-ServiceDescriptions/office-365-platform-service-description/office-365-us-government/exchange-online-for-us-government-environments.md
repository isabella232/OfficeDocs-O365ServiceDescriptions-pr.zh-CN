...
有关政府云（包括资格和购买）详细信息，请参阅政府[Microsoft 365 - 如何购买](./microsoft-365-government-how-to-buy.md)。 若要比较Office 365 政府版，请参阅Office 365 政府版[计划](https://www.microsoft.com/microsoft-365/government/compare-office-365-government-plans?rtc=1#EligibilityRequirements)。
...
|委托访问|是|是|是||
|收件箱规则|是|是|是||
|已连接帐户|是|否|否|由于出站连接GCC到第三方服务的限制，此功能在高或 DoD 中不受支持。 有关影响的功能详细信息，请参阅本文 [中的第三方](#connectivity-with-third-party-services) 服务连接。|
...
- 支持第三方文件存储提供程序 - 只有 *GCC High/DoD* 中的用户的 OneDrive for Business 帐户才能从各种 Outlook 客户端中访问，以便附加/共享文件。 无法添加 (Dropbox、Box、Google 云端硬盘) 第三方存储帐户。
...
- 将加密电子邮件从 GCC High 或 DoD 发送到该环境外部的收件人时 (包括GCC商业) ：
    ...
    - 高GCC/DoD 中的发件人可以在高/doD 边界GCC发送加密电子邮件。
...
Outlook适用于 iOS 和 Android 的 GCC 也适用于高和 DoD 环境。 若要详细了解这些环境中的功能限制和管理，请参阅 Outlook 中的使用[适用于 iOS](/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-in-the-government-cloud)和 政府社区云。
