...
若要查看授权你的用户在2020年4月1日的 Microsoft 365 合规性功能中受益的选项，请下载此[详细的 microsoft 365 合规性许可比较（PDF）](https://docs.microsoft.com/office365/servicedescriptions/downloads/microsoft-365-compliance-licensing-comparison.pdf)。
...
|[高级威胁管理](https://docs.microsoft.com/office365/securitycompliance/office-365-ti)，如仿冒活动的威胁资源管理器<sup>6</sup>  |否   |否   |否   |否   |必需   |否   |
|[客户密码箱](https://docs.microsoft.com/office365/securitycompliance/customer-lockbox-requests)  |否   |否   |否   |否   |必需   |否   |
|[移动设备管理](https://support.office.com/article/set-up-mobile-device-management-mdm-in-office-365-dd892318-bc44-4eb1-af00-9db5430be3cd)  |是   |是   |是   |是   |是   |是   |
|[Exchange online、SharePoint online 和 OneDrive for](https://docs.microsoft.com/office365/securitycompliance/data-loss-prevention-policies)business<sup>7、9</sup>的数据丢失防护 |否   |否   |否   |可访问   |是   |否   |
|[Microsoft 团队的通信数据丢失防护](https://docs.microsoft.com/microsoft-365/compliance/dlp-microsoft-teams)  |否   |否   |否   |否   |必需   |否  |
|[手动敏感度标签](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels)<sup>10</sup> | 否 | 否  | 可访问 | 是 | 是 | 否  |
|自动灵敏度标签| 否 | 否  | 否 | 否 | 是<sup>13</sup> | 否  |
|[信息屏障](https://docs.microsoft.com/office365/securitycompliance/information-barriers)  |否   |否   |否   |否   |必需   |否  |
|[信息管理](https://docs.microsoft.com/microsoft-365/compliance/manage-information-governance)<sup>1</sup>  |是   |是   |是   |是   |是   |是   |
|[高级信息治理](https://docs.microsoft.com/office365/securitycompliance/labels)<sup>2</sup>  |否   |否   |否   |否   |必需   |否   |
|[内容搜索](https://docs.microsoft.com/office365/securitycompliance/search-for-content)  |是   |是   |是   |是   |是   |是   |
|[电子数据展示事例](https://docs.microsoft.com/office365/securitycompliance/ediscovery-cases)  |是   |是   |是   |是   |是   |是   |
|[电子数据展示保留（包括基于查询的电子数据展示保留）](https://docs.microsoft.com/office365/securitycompliance/ediscovery-cases#step-4-place-content-locations-on-hold)  |否   |否   |否   |可访问   |是   |否   |
|[电子数据展示导出](https://docs.microsoft.com/office365/securitycompliance/ediscovery-cases#step-6-export-the-results-of-a-content-search-associated-with-a-case)  |否   |否   |否   |可访问   |是   |否   |
|[高级电子数据展示](https://docs.microsoft.com/office365/securitycompliance/compliance20/overview-ediscovery-20)<sup>5</sup>  |否   |否   |否   |否   |必需   |否   |
|[存档](https://docs.microsoft.com/office365/securitycompliance/enable-archive-mailboxes)  |是<sup>3</sup>  |是<sup>3</sup>  |是<sup>3</sup>  |Yes<sup>4</sup>  |是<sup>4</sup>  |否   |
|[统一审核](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance)<sup>8</sup> |是   |是   |是   |是   |是   |是   |
|[高级审核](https://docs.microsoft.com/microsoft-365/compliance/advanced-audit)<sup>12</sup> |否   |否   |否   |否   |必需   |否   |
|[通信合规性（监察策略）](https://docs.microsoft.com/office365/securitycompliance/supervision-policies)  |否   |否   |否   |否   |必需   |否   |
...
<sup>5</sup>美国和西欧（荷兰）地区支持高级电子数据展示。 （来自加拿大和亚太地区的客户数据将导出到美国。 将欧洲、中东和非洲的客户数据导出到西欧日 [荷兰]。
...
|[Exchange online、SharePoint online 和 OneDrive for business 的数据丢失防护](https://docs.microsoft.com/office365/securitycompliance/data-loss-prevention-policies)<sup>9</sup>  |否   |必需   |否   |否   |是 <sup>7<sup>  |否  |是<sup>10</sup> |否   |可访问   |
|[Microsoft 团队的通信数据丢失防护](https://docs.microsoft.com/microsoft-365/compliance/dlp-microsoft-teams)  |否   |否   |否   |否   |否   |否   |否   |否   |否   |
|[信息屏障](https://docs.microsoft.com/office365/securitycompliance/information-barriers)  |否   |否   |否   |否   |否   |否   |否   |否   |否   |
|[信息管理](https://docs.microsoft.com/office365/securitycompliance/retention-policies)<sup>1</sup>  |是<sup>2</sup>  |是   |是   |是   |是   |是<sup>10</sup>  |是<sup>10</sup>  |是   |是   |
...
|[电子数据展示导出](https://docs.microsoft.com/office365/securitycompliance/ediscovery-cases#step-6-export-the-results-of-a-content-search-associated-with-a-case)  |否   |必需   |否   |否   |必需   |否  |是<sup>10</sup> |否<sup>4</sup>  |否<sup>4</sup>  |
|[电子数据展示保留（包括基于查询的电子数据展示保留）](https://support.office.com/article/eDiscovery-cases-in-the-Office-365-Security-Compliance-Center-8dd335ab-29d0-41c3-8dd8-9f7c7481e60c#step3_1)  |否   |必需   |否   |否   |必需   |否  |是<sup>10</sup> |否<sup>4</sup>  |否<sup>4</sup>  |
...
|[存档](https://docs.microsoft.com/office365/securitycompliance/enable-archive-mailboxes)<sup>6</sup>  |否   |必需   |否   |可访问   |是   |是<sup>10</sup> |是<sup>10</sup>  |否   |否   |
|[统一审核](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance)<sup>8</sup>|是|是|是|是|是|是<sup>10</sup>|是<sup>10</sup>|否|否|
|高级审核|否|否|否|否|否|否|否|否|否|
|[通信合规性（监察策略）](https://docs.microsoft.com/office365/securitycompliance/supervision-policies)  |否   |否   |否   |否   |否   |否   |否   |否   |否   |
|[Office 365 邮件加密 (OME)](https://docs.microsoft.com/microsoft-365/compliance/ome)  |否   |否   |否   |否   |必需   |否   |否|否|否|
|[Office 365 高级邮件加密](https://docs.microsoft.com/microsoft-365/compliance/ome-advanced-message-encryption)  |否   |否   |否   |否   |必需   |否   |否|否|否|
...
<sup>3</sup>高级信息治理允许您保留重要信息，并根据保留或删除策略或这两者来分类信息，从而删除不重要的信息。 它包括智能/自动化操作，如推荐策略、自动将标签应用于数据、应用基于敏感数据类型或查询的标签、对智能导入筛选器的使用、处置评审和使用。 它还包括用于出于安全和合规目的检查员工通信的监督功能。
...
<sup>11</sup>需要 Exchange online 计划2或 Exchange online 存档许可证，才能使用保留策略将用户邮箱置于保留状态。
...
安全 & 合规性中心在由世纪互联运营的 Office 365 的任何计划中均不可用。
