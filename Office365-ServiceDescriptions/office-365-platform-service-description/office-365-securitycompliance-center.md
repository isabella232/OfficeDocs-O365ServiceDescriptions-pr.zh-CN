...
|[高级威胁管理](https://docs.microsoft.com/office365/securitycompliance/office-365-ti)，如仿冒活动的威胁资源管理器<sup>6</sup>  |否   |否   |否   |否   |否   |是   |否   |
|[客户密码箱](https://docs.microsoft.com/office365/securitycompliance/customer-lockbox-requests)  |否   |否   |否   |否   |否   |是   |否   |
...
|[Exchange online、SharePoint online 和 OneDrive for](https://docs.microsoft.com/office365/securitycompliance/data-loss-prevention-policies)business<sup>7、9</sup>的数据丢失防护 |否   |是  |是   |否   |是   |是   |否   |
|[Microsoft 团队的通信数据丢失防护](https://docs.microsoft.com/microsoft-365/compliance/dlp-microsoft-teams)  |否   |否   |否   |否   |否   |是  |
|[手动敏感度标签](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels)<sup>10</sup> | 否 | 否  |否   | 是 | 是 | 是 | 否  |
|自动灵敏度标签| 否 | 否  |否  | 否 | 否 | 是<sup>13</sup> | 否  |
|[信息屏障](https://docs.microsoft.com/office365/securitycompliance/information-barriers)  |否   |否   |否   |否   |否   |是   |否  |
|[信息管理](https://docs.microsoft.com/microsoft-365/compliance/manage-information-governance)<sup>1</sup>  |是<sup>11</sup>   |是<sup>11</sup>   |是<sup>11</sup>   |是   |是   |是   |是<sup>11</sup>   |
|[高级信息治理](https://docs.microsoft.com/office365/securitycompliance/labels)<sup>2</sup>  |否   |否   |否   |否   |否   |是   |否   |
...
|[高级电子数据展示](https://docs.microsoft.com/office365/securitycompliance/compliance20/overview-ediscovery-20)<sup>5</sup>  |否   |否   |否   |否   |否   |是   |否   |
|[存档](https://docs.microsoft.com/office365/securitycompliance/enable-archive-mailboxes)  |是<sup>3</sup>  |是<sup>3</sup>  |是<sup>3</sup>   |是<sup>3</sup>  |是<sup>4</sup>  |是<sup>4</sup>  |否   |
...
|[高级审核](https://docs.microsoft.com/microsoft-365/compliance/advanced-audit)<sup>12</sup> |否   |否   |否   |否   |否   |是   |否   |
|[) 的通信合规性 (监察策略 ](https://docs.microsoft.com/office365/securitycompliance/supervision-policies)  |否   |否   |否   |否   |否   |是   |否   |
...
<sup>8</sup> 所有包含基本审核 (的计划的审核日志（E5) 除外）保留90天。 由于 E5 包含高级审核，审核日志的保留时间最多为一年。 此外，还可以使用 [Office 365 管理活动 API](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference) 从统一审核日志中检索事件。
...
<sup>13</sup> 不包括基于机器学习的标记 (trainable 类元) 。
...
|[Exchange online、SharePoint online 和 OneDrive for business 的数据丢失防护](https://docs.microsoft.com/office365/securitycompliance/data-loss-prevention-policies)<sup>9</sup>  |否   |是   |否   |否   |是 <sup>7<sup>  |否  |是<sup>10</sup> |否   |是   |
...
|[) 的通信合规性 (监察策略 ](https://docs.microsoft.com/office365/securitycompliance/supervision-policies)  |否   |否   |否   |否   |否   |否   |否   |否   |否   |
