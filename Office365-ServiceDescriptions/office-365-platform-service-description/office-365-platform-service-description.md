...
<br/><sup>12</sup> Office 365 企业 F3，支持一对一音频/视频呼叫。 只提供“加入”这种会议权限（不得创建或发起会议）。 
<br/><sup>13</sup>在 Office 365 Enterprise F3 中，PowerApps 仅限于消耗量（不发布或共享）。 
<br/><sup>14</sup>在 Office 365 企业 F3 中，流仅限于使用，每个用户每个月限制运行数为750。 
