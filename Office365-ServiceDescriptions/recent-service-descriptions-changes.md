...
||[Office 365 平台服务说明](office-365-platform-service-description/office-365-platform-service-description.md) <br/> |向本主题添加了 FastTrack GCC部分。  <br/> |
...
|Office 网页版  <br/> |[Excel 网页版](office-online-service-description/excel-online.md) <br/> |将主题中第一个注释更改为"超过 30 MB (MB) 的工作簿无法在 Excel 网页版中从 Microsoft Office SharePoint Online 中查看。" 之前，注释中已表示为 10 MB。  <br/> |
...
|Office 网页版  <br/> |[Excel 网页版](office-online-service-description/excel-online.md) <br/> |更新为在 Web Excel冻结窗格支持。  <br/> |
...
||[由世纪互联运营的 Office 365](office-365-platform-service-description/office-365-operated-by-21vianet.md) <br/> |更新了使用 (AD RMS) IRM Windows信息权限管理。  <br/> |
...
|多个  <br/> |多个  <br/> |从 Office（由世纪Office运营的 Office 365 和 Office 365）中删除了针对 Web 和桌面比较详细信息的信息。 在 Web 服务说明Office上添加了指向相同内容的指针。  <br/> |
