...
若要详细了解 Dynamics 365 功能，请访问 [Microsoft Dynamics 365](https://www.microsoft.com/en-us/dynamics365/home)。 
  
## <a name="dynamics-365-plans"></a>Dynamics 365 计划

Dynamics 365 有两个版本: 企业版和企业版。 在这两个版本中, 有几个计划专门设计用于满足使用模式以及大型和小型企业的需求。 这些应用程序也可以单独使用。 
...
<br/><sup>2</sup>通过工作流创建、更新和删除只能针对使用权限中包含的实体执行 (即, 更新商机需要 Sales 或 Plan 1)。 
<br/><sup>3</sup>无法访问 Dynamics 365 用户界面。 案例管理和聊天只能以用户自己的身份提交, 作为 supportee, 而不代表客户或其他人。 <br/><sup>4</sup>创建 PowerApps 只能利用单个应用程序中包含的数据。 
  
## <a name="dynamics-365-service-level-agreement"></a>Dynamics 365 服务级别协议

有关使用通过 Microsoft 批量许可计划获得许可的产品和服务的相关许可条款、条件和补充信息的信息, 请参阅[Microsoft Online services 的服务级别协议](http://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=12249)。
...
查看[Microsoft Online Services 的服务级别协议](http://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=12249)下载, 获取有关服务停机时间的最新信息。 
  
\***运营水平协议**= 操作团队在服务级别协议中定义的一组服务上提供的时间。 
  
## <a name="dynamics-365-trust-center"></a>Dynamics 365 信任中心

若要了解有关 Dynamics 365 安全性、隐私和合规性的信息, 请参阅[Microsoft Dynamics 365 信任中心](https://www.microsoft.com/en-us/TrustCenter/CloudServices/Dynamics365)。
