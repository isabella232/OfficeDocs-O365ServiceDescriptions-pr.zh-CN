...
|                                         | 统一的标签和敏感度标签         | 在工程工作积压 |
| **内部风险管理**             | 客户密码箱                                | 可用            |
|                                         | 用于团队、SharePoint 网站、电子邮件消息的 Office 指示器                         | 在工程工作积压 |
|                                         | 通过去声用户窃取数据                        | 在工程工作积压 |
|                                         | 常规数据泄露                                | 在工程工作积压              |
|                                         | 调查内幕风险管理警报                                   | 在工程工作积压              
|                                         | 内幕风险管理案例仪表板、内容浏览器和通知模板 | 在工程工作积压 |
|                                         | 用于调查高级电子数据展示的升级 |在工程工作积压|
...
|                                         |  (预览中导出警报)  | 在工程工作积压 |
|                                         |  (预览的优先级用户组)  | 在工程工作积压 |
|                                         | 创建客户策略，3预配置为符合通信合规性 (包括。监察策略)   | 在工程工作积压 |
|                                         | 包括的通信合规性 (。监督策略) 对团队、Exchange 和删除团队邮件的支持 |在工程工作积压 |
|                                         | 包括的通信合规性 (。监督策略) 访问警报;通知模板;通信策略仪表板 |在工程工作积压  |
|                                         | 包括的通信合规性 (。用于调查高级电子数据展示的监察策略) 升级 | 在工程工作积压 |
...
|                                         | 高级电子数据展示：密文                                      | 即将推出 |
|                                         | 高级电子数据展示：筛选                                       | 即将推出 |
|                                         | 高级电子数据展示：保管人到工作负载映射                   | 即将推出 |
|                                         | 高级电子数据展示：保管人通信                        | 即将推出 |
|                                         | 高级电子数据展示：审阅集                                     | 即将推出 |
|                                         | 高级电子数据展示：审阅和批注                             | 即将推出 |
|                                         | 高级电子数据展示：非 Office 365 摄取                        | 即将推出 |
|                                         | 高级电子数据展示：搜索词报告                              | 即将推出 |
|                                         | 基本审核                              | 可用 |
