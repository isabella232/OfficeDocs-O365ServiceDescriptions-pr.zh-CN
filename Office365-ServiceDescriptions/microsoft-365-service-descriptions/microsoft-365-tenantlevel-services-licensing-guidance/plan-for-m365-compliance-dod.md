...
|                                         | 精确数据匹配          | 可用               |
|                                         | Exchange Online、SharePoint Online、OneDrive 的自动分类和标记                      | 即将推出              |
...
|                                         | 信息治理：导入 PST                      | 可用              |
|                                         | 信息治理：手动非记录保留标签            | 可用 |
|                                         | 信息管理： SharePoint/OneDrive for Business 库、文件夹和文档集的默认保留标签;Exchange 收件箱;和 Office 365 组 | 可用              |
...
|                                         | 内幕风险管理：调查内幕风险管理警报                                   | 在工程工作积压              |
|                                         | 内幕风险管理：事例仪表板、内容浏览器和通知模板 | 在工程工作积压 |
...
|                                         | 包括的通信合规性 (。监察策略) ：创建客户策略，3预配置  | 在工程工作积压 |
|                                         | 包括的通信合规性 (。监察策略) ：对团队、Exchange 和删除团队邮件的支持 | 在工程工作积压 |
|                                         | 包括的通信合规性 (。监督策略) ：访问警报;通知模板;通信策略仪表板 | 在工程工作积压  |
|                                         | 包括的通信合规性 (。监察策略) ：升级以供调查高级电子数据展示 | 在工程工作积压 |
|                                         | 包括的通信合规性 (。监督策略) ：检测成人内容 | 在工程工作积压 |
|                                         | 信息屏障 | 在工程工作积压 |
|                                         | 特权访问管理                    | 在工程工作积压 |
...
|                                         | 高级电子数据展示：导出 (下载、导出、添加到另一个审阅集)                                | 即将推出 |
|                                         | 高级电子数据展示：筛选                 | 即将推出 |
|                                         | 高级电子数据展示：工作组专用频道消息的合法保留                                         | 即将推出 |
|                                         | 高级电子数据展示：接近重复标识                                         | 即将推出 |
|                                         | 高级电子数据展示：非 custodial 数据源                                      | 即将推出 |
|                                         | 高级电子数据展示：预测编码                                       | 即将推出 |
|                                         | 高级电子数据展示：已处理加载文件的导出                   | 即将推出 |
|                                         | 高级电子数据展示：密文                        | 即将推出 |
|                                         | 高级电子数据展示：审阅集                                     | 即将推出 |
|                                         | 高级电子数据展示：查看数据 (查询数据、智能标记、仪表板和批注 (密文)                              | 即将推出 |
|                                         | 高级电子数据展示：搜索词报告                        | 即将推出 |
|                                         | 高级电子数据展示：标记                              | 即将推出 |
|                                         | 高级电子数据展示：租户报告                              | 即将推出 |
|                                         | 高级电子数据展示：查看者                              | 即将推出 |
|                                         | Microsoft 合规性中心中的高级电子数据展示： Yammer 高级电子数据展示                              | 即将推出 |
|                                         | 高级电子数据展示： CJK/双字节字符支持                              | 在工程工作积压 |
|                                         | 高级电子数据展示：图 Api                              | 在工程工作积压 |
|                                         | 高级电子数据展示： Microsoft 合规性中心扩展了对 SharePoint 和 OneDrive for Business 回收站中的项目的搜索和导出支持                              | 在工程工作积压 |
|                                         | 高级电子数据展示：非 Office 365 摄取和处理 (例如，OCR)                               | 在工程工作积压 |
|                                         | 高级电子数据展示：支持团队反应                              | 在工程工作积压 |
|                                         | 基本审核                              | 可用 |
