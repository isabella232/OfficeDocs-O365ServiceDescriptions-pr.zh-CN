...
Microsoft 365 中的高级审核为用户和管理员活动提供了一年审核日志保留期，并提供了创建自定义 审核日志 保留策略来管理其他 Microsoft 365 服务的 审核日志 保留。 它还提供对关键事件的访问权限，以进行调查，并提供对 Office 365 活动 API 的高带宽访问。 有关详细信息，请参阅高级审核[Microsoft 365](/microsoft-365/compliance/advanced-audit)。
...
Exchange Online 计划 2、Exchange Online Archiving、SharePoint Online 计划 2、Microsoft 365 E5/A5/E3/A3/G3、Office 365 E5/A5/E3/A3/G3 和 F5 合规性和 F5 安全 & 合规性为用户提供了从中获益的权利核心电子数据展示。
...
默认情况下，Advanced eDiscovery在安全与合规中心内分配电子数据展示权限时，租户内所有用户的租户级别启用&amp;这些功能。
...
管理员可以在"数据丢失防护 (下自定义) 安全&amp; > 与合规中心内包含的用户和已排除用户等工作负载 **的位置**。
...
管理员在邮件流规则下Exchange管理中心内创建和管理 **高级邮件** > **加密策略**。 默认情况下，这些规则适用于租户中的所有用户。 有关设置新邮件加密功能的信息，请参阅设置新的邮件Office 365 邮件加密[功能](/office365/securitycompliance/set-up-new-message-encryption-capabilities)。
...
管理员使用安全与合规中心中的 PowerShell cmdlet 创建和管理信息屏障 &amp; 策略。 管理员必须分配有全局Microsoft 365 企业版、Office 365全局管理员或合规性管理员角色，才能创建信息屏障策略。 默认情况下，这些策略适用于租户中的所有用户。 有关信息屏障详细信息，请参阅信息[障碍Microsoft Teams](/MicrosoftTeams/information-barriers-in-teams)。

### <a name="how-can-the-service-be-applied-only-to-users-in-the-tenant-who-are-licensed-for-the-service"></a>如何仅将服务应用于租户中获得服务许可的用户？

管理员可以自定义安全 (中心) 包括用户 &amp; 和排除用户等工作负载的位置。 例如，如果所有用户都获得 Office 365 E3 许可，但没有为 Office 365 高级合规版/E5 授权，则不需要为组织创建任何信息屏障策略。 有关详细信息，请参阅 [Teams](/MicrosoftTeams/information-barriers-in-teams)中的信息屏障。
...
Microsoft 365 E5/A5/G5/E3/A3/G3/Business 高级版、Office 365 E5/A5/G5/E3/A3/G3、Exchange 计划 2 和 Exchange Online Archiving 为用户提供了从组织范围或位置范围的基本邮箱保留策略中获益的权限。

Microsoft 365 E5/A5/G5/E3/A3/G3、Office 365 E5/A5/G5/E3/A3/G3 和 SharePoint 计划 2 为用户提供了从基本 SharePoint 或 OneDrive 保留策略中获益和/或手动将非记录保留标签应用于中的文件的权利SharePoint 或 OneDrive。
...
若要从适用于云应用的 Defender 中的条件访问应用控制功能中获益，用户还必须获得 Azure Active Directory P1 的许可，该 P1 包含在 企业移动性 + 安全性 F1/F3/E3/A3/G3、企业移动性 + 安全性 E5、Microsoft 365 E3/A3/G3 中，Microsoft 365 E5/A5/G5，Microsoft 365 E5/A5/G5/F5 安全Microsoft 365 F5 安全&amp;与合规。
...
权限解决方案内置在租户Microsoft 365 合规中心租户[](https://compliance.microsoft.com/homepage)内所有用户在租户级别启用。 我们建议为打算从该服务受益并保护的任何用户获取许可证。
...
记录管理功能可应用于工作组网站、组网站等 (特定位置的许可) 。 有关配置记录管理以应用于许可用户的信息，请参阅了解记录管理[中的Microsoft 365](/microsoft-365/compliance/records-management)。
