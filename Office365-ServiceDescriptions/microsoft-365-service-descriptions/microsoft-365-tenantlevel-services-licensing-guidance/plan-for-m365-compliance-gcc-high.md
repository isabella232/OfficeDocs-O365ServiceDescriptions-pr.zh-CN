...
| 敏感度标签 | Office 应用的自动分类和标签 (Word、Excel、PowerPoint、Outlook) Web、Android、iOS、Windows 和 Mac | 可用 |
| 敏感度标签 | Office 客户端的自动分类和标记 (移动)  | 工程积压工作 |
| 敏感度标签 | Teams、Microsoft 365 组和 SharePoint 网站的自动分类和标记 | 可用 |
...
| 通信合规性 | 支持更精细的权限 | 可用 |
| 通信合规性 | 支持 Teams、Exchange 以及删除 Teams 消息的能力 | 可用 |
| 通信合规性 | Microsoft Teams 集成 | 工程积压工作 |
| 通信合规性 | Teams 对话上下文 | 工程积压工作 |
...
| 电子数据展示 | 高级电子数据展示：保管人到工作负荷的映射 | 可用 |
| 电子数据展示 | 高级电子数据展示：保管人通信 | 可用 |
| 电子数据展示 | 高级电子数据展示：仪表板 | 可用 |
| 电子数据展示 | 高级电子数据展示：对中文、日语和朝鲜语的双字节支持 | 可用 |
| 电子数据展示 | 高级电子数据展示：电子邮件线程 | 可用 |
| 电子数据展示 | 高级电子数据展示： (下载、导出、添加到另一审阅集)  | 可用 |
...
| Audit | 高级审核：Microsoft 365 安全与合规中心可用性 | 可用 |
