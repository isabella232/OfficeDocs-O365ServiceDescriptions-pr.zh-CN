...
|                                         | 跨平台的 Office (Word、Excel、PowerPoint、Outlook) 自动分类和标记 (Web、Android、iOS、Windows 和 Mac)  |  开发中              |
...
|                                         | 通信合规性 (incl。监督策略) ：创建客户策略，3 个预配置  | 即将推出 |
|                                         | 通信合规性 (incl。监督策略) ：支持 Teams、Exchange 和删除 Teams 消息 | 即将推出 |
|                                         | 通信合规性 (incl。监督策略) ：访问警报;通知模板;通信策略仪表板 | 即将推出  |
|                                         | 通信合规性 (incl。监督策略) ：升级以调查高级电子数据展示 | 即将推出 |
|                                         | 通信合规性 (incl。监督策略) ：检测成人内容 | 即将推出 |
|                                         | 通信合规性：检测一段时间的重复行为违反代码 | 即将推出 |
|                                         | 通信合规性：支持更精细的权限 | 即将推出 |
|                                         | 通信合规性：分析具有 On-prem 邮箱的用户的 Teams 聊天数据 | 即将推出 |
|                                         | 通信合规性：冲突模板 | 工程积压工作 |
|                                         | 通信合规性：忽略电子邮件签名或免责声明的能力 | 工程积压工作 |
|                                         | 通信合规性：内部风险管理措施 | 工程积压工作 |
|                                         | 通信合规性：策略运行状况检查和暂停策略的能力 | 工程积压工作 |
|                                         | 通信合规性：调查期间翻译运行状况内容 | 工程积压工作 |
|                                         | 通信合规性：消耗和检测 | 工程积压工作 |
|                                         | 信息屏障 | 工程积压工作 |
|                                         | 特权访问管理                    | 工程积压工作 |
...
|                                         | 高级电子数据展示：Microsoft 合规性中心扩展了对 SharePoint 和 OneDrive for Business 回收站中项目的搜索和导出支持                              | 开发中 |
|                                         | 高级电子数据展示：Teams 反应支持                              | 开发中 |
|                                         | 基本审核                              | 可用 |
