...
|[标识和访问管理](https://docs.microsoft.com/microsoft-365/business/security-features)<br/> Microsoft 365 业务包括选择 Azure AD 高级 P1 （AADP P1）功能。 不包括 AADP1 的全部。<sup>8</sup> <br/>|**Office 365 商业高级版** <br/> |**Microsoft 365 商业版** <br/> |**企业移动性 + 安全 E3** <br/> |
...
<sup>8</sup> Microsoft 365 业务包括选择 Azure AD 高级 P1 功能，如使用 AD 写回的自助密码重置、Azure 多重身份验证（MFA）和条件访问。 它不包括完整的 Azure AD 高级 P1。</br>
...
<sup>10</sup>如果你有 windows 7 和8.1 专业版许可的设备，Microsoft 365 商业版将提供 Windows 10 专业版的升级。 使用 Microsoft 365 业务，不仅可以获得[Windows Pro 中启用的 Microsoft Defender 安全功能](https://go.microsoft.com/fwlink/p/?linkid=2089903)，还可以访问高级功能，如对基于 web 的威胁的网络保护和主机入侵防护规则，以缓解软件. 设置 Microsoft 365 商业租户时，请选择 "应用保护" 和 "设备配置设置"。 这些设置决定了在设备加入 Azure Active Directory 时自动应用于设备的策略。
