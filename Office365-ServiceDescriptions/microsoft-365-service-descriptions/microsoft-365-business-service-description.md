...
|[Microsoft 365管理](/office365/admin/admin-overview/about-the-admin-center#admin-center-features-and-settings) <br/> |**Microsoft 365 商业标准版** <br/> |**Microsoft 365 商业高级版** <br/> |
|Azure AD 连接同步工具<br/> |是  <br/> |是  <br/> |
|[共享计算机激活](/DeployOffice/overview-shared-computer-activation) <br/> |否 <br/> |是  <br/> |
...
|基于邮箱Exchange Online长期存档  <br/> |否  <br/> |是<sup>3</sup> <br/> |
...
|**Azure AD Premium P1客户可以使用Microsoft 365 商业高级版服务。**<br/>|**Microsoft 365 商业标准版** <br/> |**Microsoft 365 商业高级版** <br/> |**企业移动性 + 安全性 E3** <br/> |
...
|组织控制用户从应用程序访问Microsoft Store  <br/> |是  <br/> |
|组织控制用户访问Cortana  <br/> |是  <br/> |
|Microsoft 对Windows和广告的组织控制  <br/> |是  <br/> |
|Windows 10设备自动保持最新  <br/> |是  <br/> |
|**Windows 10安全性** <br/> |**Microsoft 365 商业高级版** <br/> |
|使用安全保护电脑免受病毒和其他Windows Defender 防病毒  <br/> |是  <br/> |
|保护电脑免受网络威胁Microsoft Edge  <br/> |是  <br/> |
|使用减少设备攻击面的规则 <br/> |是  <br/> |
|保护文件夹免受勒索软件等威胁 <br/> |是  <br/> |
|使用 Bitlocker 帮助保护电脑中的文件和文件夹免受未经授权的访问 <br/> |是  <br/> |

### <a name="notes"></a>注释
<sup>1</sup>包括Exchange Online计划 1。<br/>
<sup>2</sup> Azure 信息 (AIP) 支持的信息权限管理 (IRM) 功能。 AIP 计划 1 包含在Microsoft 365 商业高级版。 <br/>
<sup>3</sup> Microsoft 365 商业高级版计划 1 Exchange，Exchange Online Archiving仅包含在 Exchange 计划 2 (E3/E5) 。 基于云的存档和就地保留可以作为加载项购买。 每个 Exchange Online Archiving 订阅者最初都会获得 100 GB 的存档邮箱存储空间。 启用自动扩展存档后，只要达到 100 GB 存储容量，就会自动添加额外存储空间。 有关详细信息，请参阅 [无限制存档概述](/office365/securitycompliance/unlimited-archiving)。 <br/>
...
<sup>5</sup>简化Windows 10内置设备管理Microsoft 365 管理中心。 内置于设备管理管理中心的 iOS、Android、macOS 和其他跨平台设备管理的 Intune 管理功能，还获得与 Microsoft 365 商业高级版 一Microsoft 365 商业高级版。 也可在设备管理管理中心管理第三方应用和 WiFi 配置文件和 VPN 证书等内容配置。 <br/>
