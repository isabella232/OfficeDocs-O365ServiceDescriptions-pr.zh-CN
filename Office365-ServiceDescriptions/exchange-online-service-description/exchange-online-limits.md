...
|每个邮箱文件夹的子文件夹的最大数量|10000<sup>2</sup>|10000<sup>2</sup>|10000<sup>2</sup>|10000<sup>2</sup>|10000<sup>2</sup>|10000<sup>2</sup>|
...
> <sup>2</sup> 这是一个存储限制;它是邮箱形状约束之一。 对于任何给定的父文件夹，只能有10000的直接子文件夹。 无论迁移或其他创建文件夹的客户端都是如此。
