...
description: 您是否正在查找包含该订阅的订阅的功能Exchange Online？ 如果是这样，Exchange Online 服务说明文章就是您需要的内容。 您还可以了解到系统要求以及存储和收件人要求。
...
ms.locfileid: "60963494"
---
# <a name="exchange-online-service-description"></a>Exchange Online 服务说明

您是否正在查找包含该订阅的订阅的功能Exchange Online？ 如果是这样，Exchange Online 服务说明文章就是您需要的内容。 您还可以了解到系统要求以及存储和收件人要求。
...
Microsoft 365 F1不包括对邮箱Exchange权限。 为了启用完整的 Teams体验，Microsoft 365 F1 K1 服务计划Exchange Online许可证。 尽管 Exchange Online K1 服务计划将为用户设置邮箱，Microsoft 365 F1用户无权使用该邮箱。 建议通过这些步骤Outlook 网页版邮箱，并要求用户不要[](/exchange/recipients-in-exchange-online/manage-user-mailboxes/enable-or-disable-outlook-web-app)通过任何其他Exchange访问邮箱。

## <a name="system-requirements-for-exchange-online"></a>Exchange Online 的系统要求

有关系统要求，适用于企业、教育和政府组织的基于每月订阅的服务，请参阅 Microsoft 365 和 Office [Resources](https://products.office.com/office-system-requirements/#Office365forBEG)。
...
如果组织当前订阅了 Office 365 小型企业版、Office 365 小型企业高级版 或 Office 365 中型企业版，请访问 Microsoft 365 管理中心 中的邮件中心或与提供商联系，详细了解如何新建Microsoft 365 应用版计划会影响您。 若要了解有关新计划系列Microsoft 365 应用版，请参阅适用于中小型企业的新[计划](https://blogs.microsoft.com/blog/2014/10/02/new-office-365-plans-small-mid-sized-businesses-available-today)。
...
<sup>5</sup> For Exchange 2013， DLP requires an Exchange Enterprise Client Access License (CAL) . 有关 CAL 和服务器许可详细信息，请参阅Exchange[常见问题解答](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business)。 <br/>
...
<sup>7</sup>只能通过直接访问 EAC Exchange管理 (EAC) 访问。 <br/>
...
<sup>11</sup> SharePoint必须包含在订阅计划中。 <br/>
...
<sup>5</sup>对于Exchange Online Archiving基于云的存档的每个本地邮箱用户，需要一个安全订阅。 <br/>
...
<sup>11</sup> Azure 信息保护不包括在内，但可以单独购买为附加项，并启用受支持的信息权限管理 (IRM) 功能。 一些 Azure 信息保护功能需要订阅 Microsoft 365 企业应用版，Microsoft 365 商业基础版、Microsoft 365 商业标准版、Office 365 企业版 E1、Office 365 教育版 F3 Office 365 企业版或 F3。 Office 365 邮件加密取决于 Azure 信息保护。 <br/>
...
<sup>25</sup> 201 Exchange Server 3 和 Exchange Server Microsoft 365 企业应用版 2016订阅。<br/>
...
Microsoft 365计划程序是一种附加Exchange Online，它允许用户将其日程安排需求委派给数字个人助理。 助理可以安排和重新安排与组织内外人员之间的约会和会议。 助理邮箱由租户设置和控制。 若要启用计划程序，管理员需要通过 PowerShell cmdlet 设置助理的邮箱，并购买会议组织者的许可证。 若要详细了解计划程序及其工作方式，请参阅欢迎使用计划程序[进行Microsoft 365。](/microsoft-365/scheduler/scheduler-overview#how-does-scheduler-for-microsoft-365-work) 有关计划程序定价和许可，请参阅[计划程序Microsoft 365许可](https://www.microsoft.com/microsoft-365/meeting-scheduler-pricing)。
