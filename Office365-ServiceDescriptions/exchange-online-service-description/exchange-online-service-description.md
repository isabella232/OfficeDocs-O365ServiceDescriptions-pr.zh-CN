...
这些功能适用于所有商业版 (基本、标准和高级版) 、Enterprise (E1、E3、E5 和 F3) 以及 Exchange Online 计划 (1、2 和展台) – 有关详细信息，请参阅脚注。
...
- 互操作性、连接性和 [**兼容性**](/exchange/security-and-compliance/interoperability-connectivity-and-compatiblity)：Skype for Business OWA 和 Outlook 中的状态、SharePoint 互操作性、应用于模拟) 的 EWS (连接支持、SMTP 中继支持。
...
- [](/office365/servicedescriptions/exchange-online-service-description/reporting-features-and-troubleshooting-tools)报告功能和疑难解答工具 **：** Microsoft 365 管理中心报告、Excel报告工作簿、Web 服务报告、统一消息报告 (E3/E5 和仅计划 2) 。 邮件跟踪[和审核](/exchange/exchange-auditing-reports-exchange-2013-help)报告可通过直接访问 EAC Exchange管理中心 (EAC) 访问。
...
- 共享 [**和**](/exchange/sharing/sharing)协作：必须包含和部署联合共享 (包括日历发布) 、网站邮箱 (SharePoint Online 和) ，公用文件夹 (不适用于 F3 和网亭计划) 。
...
- **Exchange Online的系统** 要求：有关系统要求（适用于企业、教育以及政府组织的基于每月订阅的服务）的信息，请参阅 Microsoft 365 [和 Office Resources](https://products.office.com/office-system-requirements/#Office365forBEG)。
